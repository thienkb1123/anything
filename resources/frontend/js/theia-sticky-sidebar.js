/*! Theia Sticky Sidebar | v1.5.0 - https://github.com/WeCodePixels/theia-sticky-sidebar */ ! function(i) {
    ...
    a.fn.pbtTabs = function(e) {
        return e = a.extend({
            ...
            var t = a(this),
                ...
                i = "active";
            if (1 == e.onHover) var s = "mouseenter";
            else s = "click";
            t.prepend('<ul class="tab-items"></ul>'), n.each(function() {
                1 == e.animated && a(this).addClass("animated");
                var n = a(this).data("url");
                n ? (n = 1 == e.isLinked ? n : "#", n = 1 == e.onHover ? n : "#") : (n = "#", e.isLinked = !1), t.find(".tab-items").append('<li><a href="' + n + '">' + a(this).data("tab") + "</a></li>")
            }).eq(0).addClass(e.transition).addClass(i), t.find(".tab-items a").on(s, function() {
    ...
    var n = function(n) {
            return this.each(function() {
                ...
                e = t.extend({
                    ...
                    return e || function(t) {
                        0 === t.length && (t = "?");
                        for (var n = t.replace(/[^a-zA-Z ]/g, "").replace(/\s+/g, "_"), e = "", i = 1; null !== document.getElementById(n + e);) e = "_" + i++;
                        return n + e
                    }(t(this).text())
                }).each(function() {
                    var n = t(this),
